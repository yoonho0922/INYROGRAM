...
public class MyPageAdapterActivity extends BaseAdapter {

    private ArrayList<Map> item;

    // ListViewAdapter의 생성자
    public MyPageAdapterActivity(ArrayList item) {
        this.item = item;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.mypage_custom_view, parent, false);
        }
